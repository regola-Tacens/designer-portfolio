...
export default function ProductsDisciples () {
    ...
    const DisciplesCard = [ 
        { imageName : Disciple1,
          ...
          cardText : 'Loose elastic waist pant with allover graphics by FuneralFrench'
        },
        { imageName : Disciple2,
            cardTitle : 'Averted Visions jacket',
            cardText : 'Black cord jacket with sublimated polyester lining, featuring the Art of Funeral French'
        },
        { imageName : Disciple3,
            cardTitle : 'Outdhorror nylon vest',
            cardText : 'Light padded nylon vest with contrast inner micro mesh lining.'
        },
        { imageName : Disciple4,
            cardTitle : 'Spacegoolz tee-shirt',
            cardText : 'Long sleeve tee shirt, back screenprint and sleeve screenprint,featuring the Art of Funeral French.'
        },
        { imageName : Disciple5,
            cardTitle : 'Something out there hoodie',
            cardText : 'Pullover hoodie with front outline embroidery and sleeve screenprints on both sleeves,featuring the Art of Funeral French.'
        },
        { imageName : Disciple6,
            cardTitle : 'Extraneous LifeForms tee-shirt',
            cardText : 'Garment dyed short-sleeve tee-shirt,featuring the Art of Funeral French.'
        },
        { imageName : Disciple7,
            cardTitle : 'Black Sounds Sweatshirt',
            cardText : 'Garment dyed crew neck fleece, chest embroidery featuring the Art of Funeral French .'
        },
        { imageName : Disciple8,
            cardTitle : 'Remote chronicles long-sleeve',
            cardText : 'Garment dyed long-sleeve tee-shirt, featuring the Art of Funeral French .'
        },
        { imageName : Disciple9,
            cardTitle : 'Black Sounds Sweatshirt',
            cardText : 'Garment dyed short-sleeve tee-shirt,featuring the Art of Funeral French.'
    ...
    return <>
        ...
        <Grid container xs={12} className={classes.cardContainer}>
            {DisciplesCard.map(disciplecard => <Grid item>
                <DiscipleCarde disciplecard={disciplecard} key={disciplecard.cardTitle}/>
            </Grid>
            )}
        </Grid>
