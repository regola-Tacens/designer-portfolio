import { AppBar, Button, Drawer, IconButton, Toolbar, Menu, MenuItem, Typography, Divider } from '@material-ui/core'
...
export function NavBar(){
    ...
    const works=['Disciples of the Stone', 'Loose Trucks & Tight Lines', 'Future',
    'Macbalife', 'Girl', 'Abandonned Playgrounds', 'Volcom Industries', 'Slowburn', 'Constant Vacations' ]
    ...
    const SeasonalMenu = function({anchorEl, handleClose}){
      ...
      return <>
          ...
          >
            {works.map((work)=>(
              <MenuItem  component={RouterLink} to={work.split(' ')[0]} onClick={handleClose} >{work}</MenuItem>
            ))}
          </Menu>
        ...
        <ScrollToWhite darkPage={darkPage}>
          <AppBar position ="fixed" className={classes.bar} elevation={0}>         
              <Toolbar className={classes.menuButton}>
                <IconButton edge ='start' className={classes.menuIcon} color="inherit" aria-label="menu" onClick={toggleDrawer()}>
                  <MenuIcon />
                </IconButton>
                <Button color ="inherit"  className={classes.navIconHide} onClick={handleSeasonClick}><b>W O R K S</b></Button>
                <Button color ="inherit" className={classes.navIconHide} component={RouterLink} to="/Techs"><b>T E C H S</b></Button>
                <Button color ="inherit"  className={classes.navIconHide}><b>R E S U M E / CV</b></Button>
                <Button color ="inherit"  className={classes.navIconHide}  component={RouterLink} to="/Home" ><b>H O M E</b></Button>
                <Button color ="inherit"  className={classes.navIconHide} component={RouterLink} to="/Contact" ><b>C O N T A C T</b></Button>
