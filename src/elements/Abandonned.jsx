...
import Abandonned1 from '../images/Abandonned/Abandonned1.jpg'
...
export default function Abandonned (){

    const classes = useStyles()
    return <>
    <Grid container xs={12} className={classes.mainTech} >
        <Grid item xs={12} sm={12}  >
            <img  className={classes.pictures} src={Abandonned1} alt='LooseImg'/> 
         </Grid>
        <Grid item xs={12} sm={6} >
            <h1 className={classes.titleTech}>ABANDONNED PLAYGROUNDS</h1>
        </Grid>
